...
contract ABA is OApp, OAppOptionsType3 {
    ...
    uint256 public liquidationAmount = 321;
    ...
    function encodeMessage(
        ...
        return abi.encode(
            _message, _msgType, _liquidationAmount, extraOptionsLength, _extraReturnOptions, extraOptionsLength
        );
    }
    ...
    function quote(
        ...
        bytes memory payload = encodeMessage(_message, _msgType, _liquidationAmount, _extraReturnOptions);
    ...
    function send(
        ...
        _lzSend(
            _dstEid,
            encodeMessage(_message, _msgType, _liquidationAmount, _extraReturnOptions),
            options,
        ...
        )
    {
        ...
        (_message, _msgType, _liquidationAmount, extraOptionsLength) =
            abi.decode(encodedMessage, (string, uint16, uint256, uint256));

        return (_message, _msgType, _liquidationAmount, extraOptionsStart, extraOptionsLength);
    }
    ...
    function _lzReceive(
        ...
        if (_msgType == SEND_ABA) {
            ...
            _lzSend(
                _origin.srcEid,
                abi.encode(_newMessage, SEND, _liquidationAmount),
